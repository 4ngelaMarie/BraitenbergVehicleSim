...
-BraitenbergVehicle::Update Lines 193-203 determine time dependent weighted coefficients to determine how much food_behavior, light and bv_behavior contribute to the overall velocity upon nearing starvation (after 500 iterations.)
#### Design Document
